...
type ChittyChatClient interface {
	...
	Broadcast(ctx context.Context, in *User, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error)
}
...
func (c *chittyChatClient) Publish(ctx context.Context, in *ChatMessage, opts ...grpc.CallOption) (*PublishResponse, error) {
...
func (c *chittyChatClient) Broadcast(ctx context.Context, in *User, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ChittyChat_BroadcastClient = grpc.ServerStreamingClient[ChatMessage]
...
type ChittyChatServer interface {
	...
	Broadcast(*User, grpc.ServerStreamingServer[ChatMessage]) error
...
func (UnimplementedChittyChatServer) Publish(context.Context, *ChatMessage) (*PublishResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Publish not implemented")
}
func (UnimplementedChittyChatServer) Broadcast(*User, grpc.ServerStreamingServer[ChatMessage]) error {
...
func _ChittyChat_Broadcast_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChittyChatServer).Broadcast(m, &grpc.GenericServerStream[User, ChatMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChittyChat_BroadcastServer = grpc.ServerStreamingServer[ChatMessage]
